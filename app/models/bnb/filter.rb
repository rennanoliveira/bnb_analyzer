module Bnb
  class Filter
    ...
    attr_reader :page, :minimum_nights, :neighbourhood_group, :minimum_rating, :room_type, :property_type
    ...
    def base_query
      ...
      @bnbs = @bnbs.by_property_type(property_type) if property_type.present?
      @bnbs
    end
